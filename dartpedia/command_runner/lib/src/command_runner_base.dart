...
class CommandRunner {
  //constructor that accepts the optional callback function onError, which is called when an error occurs during command execution. 
  //The onError function takes an Exception as a parameter and returns void.
